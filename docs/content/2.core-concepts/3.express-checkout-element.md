...
## Basic Usage with CheckoutElementsProvider

```vue
<script setup>
import { loadStripe } from '@stripe/stripe-js'
import { CheckoutElementsProvider, ExpressCheckoutElement } from 'vue-stripe/checkout'
...
```vue
<script setup>
import { ExpressCheckoutElement, useCheckoutElements } from 'vue-stripe/checkout'
