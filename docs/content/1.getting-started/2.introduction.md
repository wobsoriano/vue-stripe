...
Vue Stripe is a comprehensive Vue wrapper for [Stripe.js and Elements](https://stripe.com/docs/stripe-js) with full TypeScript support. It provides a seamless way to integrate secure payment collection into your Vue applications.
...
- **Full TypeScript Support** - Complete type definitions for all components and composables
