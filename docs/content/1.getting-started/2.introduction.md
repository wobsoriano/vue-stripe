...
seo:
  ...
  description: Vue components for Stripe.js and Elements. Integrate secure payment collection into your Vue applications.
---

## Introduction

Vue Stripe is a comprehensive Vue wrapper for [Stripe.js and Elements](https://stripe.com/docs/stripe-js). It provides a seamless way to integrate secure payment collection into your Vue applications.
